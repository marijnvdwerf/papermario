...
EvtScript N(EVS_Scene_StarSpiritsPlea) = {
    ...
    EVT_CALL(NpcJump0, NPC_Eldstar, 21, 260, -277, 25)
    ...
    EVT_CALL(SetCamSpeed, CAM_DEFAULT, EVT_FLOAT(3.36))
    ...
    EVT_SETF(MV_AlphaAmt_Others, EVT_FLOAT(40.0))
    EVT_LOOP(20)
        EVT_ADDF(MV_AlphaAmt_Eldstar, EVT_FLOAT(-7.2))
        EVT_ADDF(MV_AlphaAmt_Others, EVT_FLOAT(-7.2))
        EVT_WAIT(1)
    EVT_END_LOOP
