...
/* 1CC5C 8004185C 3C15800B */  lui        $s5, %hi(gCurrentEncounter)
/* 1CC60 80041860 26B5F5E0 */  addiu      $s5, $s5, %lo(gCurrentEncounter)
/* 1CC64 80041864 AFB7002C */  sw         $s7, 0x2C($sp)
/* 1CC68 80041868 3C178011 */  lui        $s7, %hi(gPlayerData)
/* 1CC6C 8004186C 26F7DD90 */  addiu      $s7, $s7, %lo(gPlayerData)
/* 1CC70 80041870 3C048009 */  lui        $a0, %hi(gEncounterSubState)
/* 1CC74 80041874 248469A4 */  addiu      $a0, $a0, %lo(gEncounterSubState)
...
.LPAL_800418D4:
/* 1CCD4 800418D4 3C02800F */  lui        $v0, %hi(gPlayerStatusPtr)
/* 1CCD8 800418D8 8C423F60 */  lw         $v0, %lo(gPlayerStatusPtr)($v0)
/* 1CCDC 800418DC 3C018009 */  lui        $at, %hi(D_8009A654)
/* 1CCE0 800418E0 A0206A2C */  sb         $zero, %lo(D_8009A654)($at)
/* 1CCE4 800418E4 3C018007 */  lui        $at, %hi(D_80077C40)
/* 1CCE8 800418E8 AC203FE0 */  sw         $zero, %lo(D_80077C40)($at)
...
/* 1CD00 80041900 0C0B1D7A */  jal        suspend_all_group
...
/* 1CD5C 8004195C 0C0B1D08 */  jal        suspend_all_script
...
/* 1CD70 80041970 0C0B1D08 */  jal        suspend_all_script
...
/* 1CDD4 800419D4 3C018009 */  lui        $at, %hi(gEncounterSubState)
/* 1CDD8 800419D8 AC2269A4 */  sw         $v0, %lo(gEncounterSubState)($at)
/* 1CDDC 800419DC 0801078D */  j          .LPAL_80041E34
/* 1CDE0 800419E0 00000000 */   nop
.LPAL_800419E4:
/* 1CDE4 800419E4 3C028007 */  lui        $v0, %hi(gGameStatusPtr)
/* 1CDE8 800419E8 8C4214AC */  lw         $v0, %lo(gGameStatusPtr)($v0)
...
/* 1CE0C 80041A0C 3C018009 */  lui        $at, %hi(gEncounterSubState)
/* 1CE10 80041A10 AC3169A4 */  sw         $s1, %lo(gEncounterSubState)($at)
...
/* 1CE34 80041A34 0C039968 */  jal        is_ability_active
...
/* 1CE80 80041A80 3C018007 */  lui        $at, %hi(D_80077C40)
/* 1CE84 80041A84 AC323FE0 */  sw         $s2, %lo(D_80077C40)($at)
/* 1CE88 80041A88 3C018009 */  lui        $at, %hi(gEncounterSubState)
/* 1CE8C 80041A8C AC3169A4 */  sw         $s1, %lo(gEncounterSubState)($at)
/* 1CE90 80041A90 0801078D */  j          .LPAL_80041E34
/* 1CE94 80041A94 00000000 */   nop
.LPAL_80041A98:
/* 1CE98 80041A98 8EB0008C */  lw         $s0, 0x8C($s5)
.LPAL_80041A9C:
/* 1CE9C 80041A9C 0C039968 */  jal        is_ability_active
...
/* 1CEEC 80041AEC 0C039968 */  jal        is_ability_active
...
/* 1CF3C 80041B3C 3C018007 */  lui        $at, %hi(D_80077C40)
/* 1CF40 80041B40 AC223FE0 */  sw         $v0, %lo(D_80077C40)($at)
/* 1CF44 80041B44 24020002 */  addiu      $v0, $zero, 0x2
/* 1CF48 80041B48 AEA00094 */  sw         $zero, 0x94($s5)
/* 1CF4C 80041B4C 3C018009 */  lui        $at, %hi(gEncounterSubState)
/* 1CF50 80041B50 AC2269A4 */  sw         $v0, %lo(gEncounterSubState)($at)
...
.LPAL_80041BB8:
/* 1CFB8 80041BB8 0C0526CF */  jal        bgm_set_battle_song
/* 1CFBC 80041BBC 00000000 */   nop
.LPAL_80041BC0:
/* 1CFC0 80041BC0 0C0526AA */  jal        bgm_push_battle_song
/* 1CFC4 80041BC4 00000000 */   nop
/* 1CFC8 80041BC8 24020001 */  addiu      $v0, $zero, 0x1
/* 1CFCC 80041BCC 3C018009 */  lui        $at, %hi(D_8009A654)
/* 1CFD0 80041BD0 A0226A2C */  sb         $v0, %lo(D_8009A654)($at)
/* 1CFD4 80041BD4 2402000A */  addiu      $v0, $zero, 0xA
/* 1CFD8 80041BD8 AEA2009C */  sw         $v0, 0x9C($s5)
/* 1CFDC 80041BDC 24020001 */  addiu      $v0, $zero, 0x1
/* 1CFE0 80041BE0 3C018009 */  lui        $at, %hi(gEncounterSubState)
/* 1CFE4 80041BE4 AC2269A4 */  sw         $v0, %lo(gEncounterSubState)($at)
.LPAL_80041BE8:
...
/* 1D054 80041C54 0C0B1C2B */  jal        kill_script_by_ID
...
/* 1D090 80041C90 0C039968 */  jal        is_ability_active
...
.LPAL_80041CBC:
/* 1D0BC 80041CBC 0C052207 */  jal        sfx_stop_sound
/* 1D0C0 80041CC0 24042111 */   addiu     $a0, $zero, 0x2111
/* 1D0C4 80041CC4 0C052207 */  jal        sfx_stop_sound
/* 1D0C8 80041CC8 24042112 */   addiu     $a0, $zero, 0x2112
/* 1D0CC 80041CCC 0C052207 */  jal        sfx_stop_sound
/* 1D0D0 80041CD0 24042113 */   addiu     $a0, $zero, 0x2113
/* 1D0D4 80041CD4 0C052207 */  jal        sfx_stop_sound
/* 1D0D8 80041CD8 24042114 */   addiu     $a0, $zero, 0x2114
/* 1D0DC 80041CDC 0C01BFFB */  jal        set_battle_formation
/* 1D0E0 80041CE0 0000202D */   daddu     $a0, $zero, $zero
/* 1D0E4 80041CE4 86840046 */  lh         $a0, 0x46($s4)
/* 1D0E8 80041CE8 0C01BFF7 */  jal        set_battle_stage
/* 1D0EC 80041CEC 00000000 */   nop
/* 1D0F0 80041CF0 0C01BFE8 */  jal        load_battle
...
/* 1D120 80041D20 0C04DA4A */  jal        set_screen_overlay_params_front
/* 1D124 80041D24 AEA20090 */   sw        $v0, 0x90($s5)
/* 1D128 80041D28 24020005 */  addiu      $v0, $zero, 0x5
/* 1D12C 80041D2C 3C018009 */  lui        $at, %hi(gEncounterState)
/* 1D130 80041D30 AC2269D4 */  sw         $v0, %lo(gEncounterState)($at)
...
/* 1D1A0 80041DA0 0C0B1C2B */  jal        kill_script_by_ID
...
/* 1D1DC 80041DDC 3C018009 */  lui        $at, %hi(gEncounterState)
/* 1D1E0 80041DE0 AC2269D4 */  sw         $v0, %lo(gEncounterState)($at)
...
.LPAL_80041DF4:
/* 1D1F4 80041DF4 3C018009 */  lui        $at, %hi(D_8009A678)
/* 1D1F8 80041DF8 AC226A50 */  sw         $v0, %lo(D_8009A678)($at)
/* 1D1FC 80041DFC 3C018009 */  lui        $at, %hi(gEncounterSubState)
/* 1D200 80041E00 AC2069A4 */  sw         $zero, %lo(gEncounterSubState)($at)
...
/* 1D220 80041E20 3C018009 */  lui        $at, %hi(gEncounterState)
/* 1D224 80041E24 AC2269D4 */  sw         $v0, %lo(gEncounterState)($at)
/* 1D228 80041E28 3C018009 */  lui        $at, %hi(D_8009A678)
/* 1D22C 80041E2C AC256A50 */  sw         $a1, %lo(D_8009A678)($at)
