...
/* 26510 8004B110 3C018007 */  lui        $at, %hi(D_PAL_80074520)
/* 26514 8004B114 A0224520 */  sb         $v0, %lo(D_PAL_80074520)($at)
/* 26518 8004B118 3C018007 */  lui        $at, %hi(D_PAL_80074510)
/* 2651C 8004B11C A0204510 */  sb         $zero, %lo(D_PAL_80074510)($at)
/* 26520 8004B120 0C016140 */  jal        func_PAL_80058500
...
/* 26538 8004B138 0C0188F4 */  jal        func_PAL_800623D0
...
/* 26564 8004B164 3C12800A */  lui        $s2, %hi(D_PAL_800A1C80)
/* 26568 8004B168 26521C80 */  addiu      $s2, $s2, %lo(D_PAL_800A1C80)
...
/* 2658C 8004B18C 3C028005 */  lui        $v0, %hi(func_PAL_8004B804)
/* 26590 8004B190 2442B804 */  addiu      $v0, $v0, %lo(func_PAL_8004B804)
...
/* 265B8 8004B1B8 3C01800A */  lui        $at, %hi(D_PAL_800A1DA4)
/* 265BC 8004B1BC AC221DA4 */  sw         $v0, %lo(D_PAL_800A1DA4)($at)
/* 265C0 8004B1C0 2442FE90 */  addiu      $v0, $v0, -0x170
/* 265C4 8004B1C4 3C01800A */  lui        $at, %hi(D_PAL_800A1DA8)
/* 265C8 8004B1C8 AC221DA8 */  sw         $v0, %lo(D_PAL_800A1DA8)($at)
.LPAL_8004B1CC:
...
/* 265D8 8004B1D8 0C01615C */  jal        func_PAL_80058570
...
/* 26604 8004B204 3C068007 */  lui        $a2, %hi(D_PAL_800704B0)
/* 26608 8004B208 24C604B0 */  addiu      $a2, $a2, %lo(D_PAL_800704B0)
/* 2660C 8004B20C 3C058009 */  lui        $a1, %hi(D_PAL_80093E70)
/* 26610 8004B210 24A53E70 */  addiu      $a1, $a1, %lo(D_PAL_80093E70)
/* 26614 8004B214 24040800 */  addiu      $a0, $zero, 0x800
/* 26618 8004B218 3C03800A */  lui        $v1, %hi(D_PAL_800A1C90)
/* 2661C 8004B21C 24631C90 */  addiu      $v1, $v1, %lo(D_PAL_800A1C90)
.LPAL_8004B220:
...
/* 2666C 8004B26C 3C10800A */  lui        $s0, %hi(D_PAL_800A1D98)
/* 26670 8004B270 26101D98 */  addiu      $s0, $s0, %lo(D_PAL_800A1D98)
.LPAL_8004B274:
/* 26674 8004B274 24050001 */  addiu      $a1, $zero, 0x1
/* 26678 8004B278 02258821 */  addu       $s1, $s1, $a1
/* 2667C 8004B27C 3C06800A */  lui        $a2, %hi(D_PAL_800A1DA4)
/* 26680 8004B280 8CC61DA4 */  lw         $a2, %lo(D_PAL_800A1DA4)($a2)
/* 26684 8004B284 8FA4002C */  lw         $a0, 0x2C($sp)
/* 26688 8004B288 0C01615C */  jal        func_PAL_80058570
...
/* 266A4 8004B2A4 3C02800A */  lui        $v0, %hi(D_800A2350)
/* 266A8 8004B2A8 24422350 */  addiu      $v0, $v0, %lo(D_800A2350)
...
/* 266C0 8004B2C0 0C012E73 */  jal        func_PAL_8004B9CC
...
/* 266D8 8004B2D8 0C01615C */  jal        func_PAL_80058570
...
/* 266F8 8004B2F8 0C01615C */  jal        func_PAL_80058570
/* 266FC 8004B2FC 24060500 */   addiu     $a2, $zero, 0x500
/* 26700 8004B300 3C04800A */  lui        $a0, %hi(D_PAL_800A1DB0)
/* 26704 8004B304 24841DB0 */  addiu      $a0, $a0, %lo(D_PAL_800A1DB0)
...
/* 26738 8004B338 3C028005 */  lui        $v0, %hi(func_PAL_8004B908)
/* 2673C 8004B33C 2442B908 */  addiu      $v0, $v0, %lo(func_PAL_8004B908)
/* 26740 8004B340 3C018007 */  lui        $at, %hi(D_PAL_80074514)
/* 26744 8004B344 AC224514 */  sw         $v0, %lo(D_PAL_80074514)($at)
/* 26748 8004B348 0C015A0C */  jal        func_PAL_80056830
/* 2674C 8004B34C 27A50018 */   addiu     $a1, $sp, 0x18
/* 26750 8004B350 8FA40020 */  lw         $a0, 0x20($sp)
/* 26754 8004B354 0C014D0F */  jal        func_PAL_8005343C
...
/* 2676C 8004B36C 3C068005 */  lui        $a2, %hi(func_PAL_8004B3E8)
/* 26770 8004B370 24C6B3E8 */  addiu      $a2, $a2, %lo(func_PAL_8004B3E8)
/* 26774 8004B374 3C02800A */  lui        $v0, %hi(D_PAL_800A1C80)
/* 26778 8004B378 24421C80 */  addiu      $v0, $v0, %lo(D_PAL_800A1C80)
