...
/* 42B18 80067718 10A30006 */  beq        $a1, $v1, .L80067734
...
.L80067734:
/* 42B34 80067734 14A60008 */  bne        $a1, $a2, .L80067758
...
/* 42B48 80067748 14800004 */  bnez       $a0, .L8006775C
/* 42B4C 8006774C 27A5001C */   addiu     $a1, $sp, 0x1C
/* 42B50 80067750 08019DD7 */  j          .L8006775C
...
/* 42BD0 800677D0 5483002B */  bnel       $a0, $v1, .L80067880
...
/* 42C30 80067830 10600008 */  beqz       $v1, .L80067854
...
/* 42C8C 8006788C 16630008 */  bne        $s3, $v1, .L800678B0
...
/* 42CA0 800678A0 54800004 */  bnel       $a0, $zero, .L800678B4
/* 42CA4 800678A4 8E440010 */   lw        $a0, 0x10($s2)
/* 42CA8 800678A8 08019DE5 */  j          .L80067794
...
/* 42CF0 800678F0 10600065 */  beqz       $v1, .L80067A88
/* 42CF4 800678F4 00021080 */   sll       $v0, $v0, 2
/* 42CF8 800678F8 3C03800A */  lui        $v1, %hi(jtbl_80098980)
/* 42CFC 800678FC 00621821 */  addu       $v1, $v1, $v0
/* 42D00 80067900 8C638980 */  lw         $v1, %lo(jtbl_80098980)($v1)
...
/* 42D28 80067928 1462000E */  bne        $v1, $v0, .L80067964
...
/* 42D3C 8006793C 1440000A */  bnez       $v0, .L80067968
...
/* 42D5C 8006795C 08019EA3 */  j          .L80067A8C
...
/* 42D7C 8006797C 08019EA3 */  j          .L80067A8C
...
/* 42DB0 800679B0 08019EA3 */  j          .L80067A8C
...
/* 42DD4 800679D4 14620010 */  bne        $v1, $v0, .L80067A18
...
/* 42DE8 800679E8 1440000C */  bnez       $v0, .L80067A1C
...
/* 42E10 80067A10 08019EA3 */  j          .L80067A8C
...
/* 42E38 80067A38 08019EA3 */  j          .L80067A8C
...
/* 42E74 80067A74 08019EA3 */  j          .L80067A8C
...
.L80067A8C:
/* 42E8C 80067A8C 1440FF0B */  bnez       $v0, .L800676BC
...
/* 42EB0 80067AB0 14620014 */  bne        $v1, $v0, .L80067B04
/* 42EB4 80067AB4 8FA50018 */   lw        $a1, 0x18($sp)
/* 42EB8 80067AB8 12800012 */  beqz       $s4, .L80067B04
...
/* 42F20 80067B20 08019DAF */  j          .L800676BC
