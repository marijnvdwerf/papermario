...
/* 47410 8006C010 10400007 */  beqz       $v0, .L8006C030
...
/* 47428 8006C028 1440FFFD */  bnez       $v0, .L8006C020
...
/* 4744C 8006C04C 50830044 */  beql       $a0, $v1, .L8006C160
/* 47450 8006C050 8D03000C */   lw        $v1, 0xC($t0)
/* 47454 8006C054 1520001C */  bnez       $t1, .L8006C0C8
/* 47458 8006C058 90E30005 */   lbu       $v1, 0x5($a3)
/* 4745C 8006C05C 91020005 */  lbu        $v0, 0x5($t0)
/* 47460 8006C060 10620004 */  beq        $v1, $v0, .L8006C074
...
/* 4747C 8006C07C 10620004 */  beq        $v1, $v0, .L8006C090
...
/* 47498 8006C098 10620004 */  beq        $v1, $v0, .L8006C0AC
...
/* 474E8 8006C0E8 10620004 */  beq        $v1, $v0, .L8006C0FC
...
/* 47504 8006C104 10620004 */  beq        $v1, $v0, .L8006C118
...
/* 47520 8006C120 10620004 */  beq        $v1, $v0, .L8006C134
