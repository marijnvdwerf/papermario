...
/* 44044 80068C44 1440003F */  bnez       $v0, .L80068D44
...
/* 44068 80068C68 14400036 */  bnez       $v0, .L80068D44
/* 4406C 80068C6C 8FBF0148 */   lw        $ra, 0x148($sp)
/* 44070 80068C70 97A20114 */  lhu        $v0, 0x114($sp)
/* 44074 80068C74 10400003 */  beqz       $v0, .L80068C84
/* 44078 80068C78 8FA20110 */   lw        $v0, 0x110($sp)
/* 4407C 80068C7C 14400003 */  bnez       $v0, .L80068C8C
/* 44080 80068C80 00009821 */   addu      $s3, $zero, $zero
.L80068C84:
/* 44084 80068C84 0801A350 */  j          .L80068D40
...
/* 440A4 80068CA4 14400010 */  bnez       $v0, .L80068CE8
/* 440A8 80068CA8 00031202 */   srl       $v0, $v1, 8
/* 440AC 80068CAC 10510008 */  beq        $v0, $s1, .L80068CD0
...
/* 440C8 80068CC8 1440001E */  bnez       $v0, .L80068D44
...
/* 440E0 80068CE0 0801A326 */  j          .L80068C98
/* 440E4 80068CE4 94500000 */   lhu       $s0, 0x0($v0)
.L80068CE8:
/* 440E8 80068CE8 24020001 */  addiu      $v0, $zero, 0x1
/* 440EC 80068CEC 14620014 */  bne        $v1, $v0, .L80068D40
...
/* 44138 80068D38 0801A351 */  j          .L80068D44
