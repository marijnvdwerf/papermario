...
/* 441B0 80068DB0 10400049 */  beqz       $v0, .L80068ED8
...
/* 441C4 80068DC4 15200046 */  bnez       $t1, .L80068EE0
/* 441C8 80068DC8 8FBF004C */   lw        $ra, 0x4C($sp)
/* 441CC 80068DCC 8E220050 */  lw         $v0, 0x50($s1)
/* 441D0 80068DD0 1840003F */  blez       $v0, .L80068ED0
...
/* 441F8 80068DF8 15200038 */  bnez       $t1, .L80068EDC
...
/* 44210 80068E10 15200025 */  bnez       $t1, .L80068EA8
/* 44214 80068E14 97A20014 */   lhu       $v0, 0x14($sp)
/* 44218 80068E18 54550029 */  bnel       $v0, $s5, .L80068EC0
/* 4421C 80068E1C 8E220050 */   lw        $v0, 0x50($s1)
/* 44220 80068E20 8FA20010 */  lw         $v0, 0x10($sp)
/* 44224 80068E24 54560026 */  bnel       $v0, $s6, .L80068EC0
/* 44228 80068E28 8E220050 */   lw        $v0, 0x50($s1)
/* 4422C 80068E2C 1260000C */  beqz       $s3, .L80068E60
...
/* 4424C 80068E4C 14A2001A */  bne        $a1, $v0, .L80068EB8
/* 44250 80068E50 24C60001 */   addiu     $a2, $a2, 0x1
/* 44254 80068E54 28C20010 */  slti       $v0, $a2, 0x10
/* 44258 80068E58 1440FFF9 */  bnez       $v0, .L80068E40
/* 4425C 80068E5C 00E61821 */   addu      $v1, $a3, $a2
.L80068E60:
/* 44260 80068E60 1240000E */  beqz       $s2, .L80068E9C
/* 44264 80068E64 00000000 */   nop
/* 44268 80068E68 55000015 */  bnel       $t0, $zero, .L80068EC0
